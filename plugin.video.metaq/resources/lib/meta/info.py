...
def get_movie_metadata(movie, genres_dict=None):
    ...
    else: info['poster'] = "https://raw.githubusercontent.com/htpctv/style/master/MetaQ/default/unavailable.png"
...
def item_images(type, tmdb_id=None, imdb_id=None, tvdb_id=None, name=None):
    ...
    if isinstance(response, dict):
        ...
        else                            : poster = "https://raw.githubusercontent.com/htpctv/style/master/MetaQ/default/unavailable.png"
