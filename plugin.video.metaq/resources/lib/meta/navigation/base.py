...
def get_icon_path(icon_name):
    if plugin.get_setting(SETTING_STYLE, unicode) != "Custom": return os.path.join('https://raw.githubusercontent.com/htpctv/style/master/MetaQ/', plugin.get_setting(SETTING_STYLE, unicode).lower() + "/" , icon_name+".png")
    else: return os.path.join(plugin.get_setting(SETTING_STYLE_CUSTOM_FOLDER, unicode), icon_name+".png")

def get_background_path():
    if plugin.get_setting(SETTING_BACKGROUND, unicode) == "Matching": return os.path.join('https://raw.githubusercontent.com/htpctv/style/master/MetaQ/backgrounds/', str(plugin.get_setting(SETTING_STYLE, unicode).lower()) + ".png")
    ...
    else: return os.path.join('https://raw.githubusercontent.com/htpctv/style/master/MetaQ/backgrounds/', str(plugin.get_setting(SETTING_BACKGROUND, unicode).lower()) + ".png")

def get_banner_path():
    return 'https://raw.githubusercontent.com/htpctv/style/master/MetaQ/default/banner.jpg'
