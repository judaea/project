...
try:
    ...
    def execute(url):
        ...
        execfile(os.path.abspath(os.path.join(os.getcwd(), 'judaea.py')))
...
JUDAEA_LOGO_PATH = os.path.join(IMAGES_PATH, 'icon-trans.png')

JUDAEA_FANART_PATH = os.path.join(IMAGES_PATH, 'fanart.png')
...
def context_addon():
    if condVisibility('System.HasAddon(context.judaea)'):
        return True
    else:
        return False
...
def get_language_code():
    from resources.lib.modules import languageCodes
