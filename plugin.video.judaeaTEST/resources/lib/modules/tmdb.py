...
class TMDBAPI:
    def __init__(self):
        ...
        self.movies_poster_limit = int(control.getSetting('movies.poster_limit'))
        self.movies_fanart_limit = int(control.getSetting('movies.fanart_limit'))
        self.movies_landscape = bool(control.getSetting('movies.landscape'))

        self.tvshows_poster_limit = int(control.getSetting('tvshows.poster_limit'))
        self.tvshows_landscape = control.getSetting('tvshows.landscape')
        self.season_poster = control.getSetting('season.poster')
        self.episode_fanart = bool(control.getSetting('episode.fanart'))

        self.tvshows_prefer_fanart = control.getSetting('tvshows.preferedsource') == '0'
        self.movies_prefer_fanart = control.getSetting('movies.preferedsource') == '0'
    ...
    def get_request(self, url):
        try:
            ...
            try:
                ...
                control.showDialog.notification(control.addonName, control.lang(32028))
                return
    ...
    def showSeasonToListItem(self, seasonObject, showArgs):
        ...
        try:
            ...
            try:
                ...
                airdate = control.datetime_workaround(airdate)
            ...
            try:
                ...
                pass
            try:
                item['info']['trailer'] = control.youtube_url % \
    ...
    def movieToListItem(self, trakt_object):
        ...
        try:
            ...
            try:
                info['trailer'] = control.youtube_url % \
                                  [i for i in details['videos']['results'] if i['site'] == 'YouTube'][0]['key']
            except:
                pass
    ...
    def parseEpisodeInfo(self, response, traktInfo, showArgs):
        try:
            ...
            try:
                response['name'] = control.deaccentString(response['name'])
            except:
                pass
            try:
                currentDate = datetime.today().date()
            ...
            try:
                ...
                pass
            try:
                info['title'] = info['sorttitle'] = info['originaltitle'] = control.deaccentString(response['name'])
            except:
                return None
            try:
