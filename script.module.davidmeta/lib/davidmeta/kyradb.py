...
class KyraDBAPI:
    def __init__(self, api_key, user_key):
        self.gifs_path = 'special://userdata/addon_data/script.module.davidmeta/animated_gifs/'
    ...
    def _get(self, url):
        headers = {'User-Agent': 'David Kodi', 'Content-type': 'application/json', 'Apikey': self.api_key, 'Userkey': self.user_key}
