"""
    ...
    <dir>
        <title>Newest</title>
        <imdb>tvshows/new</imdb>
        <thumbnail></thumbnail>
    </dir>

    <dir>
        <title>Best Ratings</title>
        <imdb>tvshows/rating</imdb>
        <thumbnail></thumbnail>
    </dir>

    <dir>
        <title>Most Viewed</title>
        <imdb>tvshows/mostviews</imdb>
        <thumbnail></thumbnail>
    </dir>
    ...
    <dir>
        ...
        <imdb>charttv/toptv</imdb>
    </dir>

    ###Genres
    <dir>
        <title>IMDB Action TV Shows</title>
        <imdb>genres/action</imdb>
        <thumbnail></thumbnail>
    </dir>
    ...
    <dir>
        ...
        <imdb>movies/trending</imdb>
    </dir>

    <dir>
    <title>2016</title>
        <imdb>years/2016</imdb>
        <thumbnail></thumbnail>
    </dir>
    ...
    def process_item(self, item_xml):
        if "<imdb>" in item_xml:
            ...
            if "movies/" in item.get("imdb", ""):
                ...
                result_item['fanart_small'] = result_item["fanart"]
                return result_item
            elif "theepisodeTwo/" in item.get("imdb", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                ...
                result_item['fanart_small'] = result_item["fanart"]
                return result_item
            elif "moviecalendar/" in item.get("imdb", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                ...
                result_item['fanart_small'] = result_item["fanart"]
                return result_item
            elif "www.imdb.com" in item.get("imdb", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                ...
                result_item['fanart_small'] = result_item["fanart"]
                return result_item
            elif "genrestv/" in item.get("imdb", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                ...
                result_item['fanart_small'] = result_item["fanart"]
                return result_item
            elif "searchmovies" in item.get("imdb", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                ...
                result_item['fanart_small'] = result_item["fanart"]
                return result_item
            elif "searchseries" in item.get("imdb", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
...
def imdbmovies(url):
    ...
    try:
        ...
        xml += "<dir>"\
               ...
               "<imdb>http://www.imdb.com/search/title%s</imdb>"\
