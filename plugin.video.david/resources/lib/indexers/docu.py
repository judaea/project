...
from resources.lib.modules import client,control,cache,log_utils
try:
    import resolveurl
except:
    pass
    ...
    def root(self):
        try:
            ...
            for content in cat_list:
                ...
                cat_action = 'docuNavigator&docuCat=%s' % cat_url
    ...
    def docu_list(self, url):
        try:
            ...
            for content in cat_list:
                ...
                docu_action = 'docuNavigator&docuPlay=%s' % docu_url
            ...
            try:
                ...
                docu_action = 'docuNavigator&docuCat=%s' % link
        ...
        try:
            ...
            if 'youtube' in url:
                if 'videoseries' not in url:
                    ...
                    url = resolveurl.resolve('https://www.youtube.com/watch?v=%s' % video_id)
                else:
                    pass
