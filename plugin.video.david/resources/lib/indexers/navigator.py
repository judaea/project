...
class navigator:
    ...
    def root(self):
        ...
        if self.getMenuEnabled('navi.radio') == True:
            self.addDirectoryItem('Radio', 'radioNavigator', 'music.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.docu') == True:
            self.addDirectoryItem('Documentaries', 'docuNavigator', 'userlists.png', 'DefaultTVShows.png')
