...
default_pm_icon = os.path.join(icon_directory, 'tools.png')
...
def pm_rename(file_type, file_id, current_name):
    ...
    if result == 'success':
        ...
        return dialog.ok('David', 'Error Renaming Premiumize %s.' % file_type.capitalize())
...
def pm_account_info():
    ...
    try:
        ...
        return dialog.ok('David', 'Error Getting Premiumize Info..', e)
