...
import sys,re,json,urllib,urlparse,random,datetime,time,openscrapers
...
#        filter += [i for i in self.sources if not i['source'].lower() in self.hostprDict and i['debridonly'] is False]
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.exegesis.container.items'

        self.metaProperty = 'plugin.video.exegesis.container.meta'
