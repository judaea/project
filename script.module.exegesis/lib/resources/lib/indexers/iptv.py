...
from resources.lib.modules import cache,client,control,metacache
from resources.lib.modules import regex,views,workers,youtube,trailer
try:
...
#             pass
    ...
    def rootAdult(self):
        try:
            regex.clear()
            url = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2p1ZGFlYS9wcm9qZWN0L21hc3Rlci9tZW51cy9saXN0cy9hZHVsdC50eHQ='.decode('base64')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def noname_list(self, url, result=None):
        try:
            ...
            try:
                ...
                fanart = '0'
            api_data = client.request(base64.b64decode('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2h0cGN0di9wcm9qZWN0L21hc3Rlci9tZW51cy9saXN0cy9hcGkudHh0'), timeout='5')
