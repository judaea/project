...
#         self.endDirectory()
    ...
    def tools(self):
        ...
        self.addDirectoryItem('[B]Exegesis[/B] : Library', 'libraryNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Exegesis[/B] : Viewtypes', 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Exegesis[/B] : Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Exegesis[/B] : Clear Search History', 'clearCacheSearch', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Exegesis[/B] : Clear Provider Sources', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Exegesis[/B] : News, Updates & Information', 'newsNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Trakt[/B] : Authorize Exegesis With Trakt', 'authTrakt', 'trakt.png', 'DefaultAddonProgram.png')
    ...
    def library(self):
        self.addDirectoryItem(32557, 'openSettings&query=6.0', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def addDirectoryItem(self, name, query, thumb, icon, context=None, queue=False, isAction=True, isFolder=True):
        ...
        cm = []
        cm.append(('Exegesis Settings', 'RunPlugin(%s?action=openSettings&query=(0,0))' % sysaddon))
