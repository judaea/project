...
class SkinManager:
    ...
    def __init__(self):
        ...
        self.judaea_skins = ['Judaea Fox', 'Default']
        ...
        self.judaea_default_window_path = os.path.join(control.addonDir, 'resources', 'skins', 'judaea_backup_files')
    ...
    def get_active_skin(self):
        cursor = database._get_connection_cursor(control.SKINS_DB_PATH)
    ...
    def install_skin(self, zip_location=None):
        ...
        switch_skin = control.showDialog.yesno(control.addonName, control.lang(40158).encode('utf-8') %
    ...
    def _select_installed_skin(self, hide_default=False):
        ...
        if hide_default:
            installed_skins.remove('Judaea Fox')

        selection = control.showDialog.select(control.addonName, installed_skins)
    ...
    def _extract_zip(self, install_package, skin_meta):
        ...
        try:
            ...
            file_path = ''
        control.log('%sresources/' % file_path)
    ...
    def _get_skin_meta(self, zip_file):
        ...
        if meta_file is None:
            control.log('%s/meta.json' % file_list[0])
    ...
    def _create_database(self):
        ...
        default_installed = cursor.execute('UPDATE skins SET '
                                           ...
                                           ('Judaea Fox', '1.0.0', 'Judaea', 'Judaea Fox'))
        if default_installed.rowcount == 0:
            cursor.execute('INSERT INTO skins VALUES (?,?,?,?)', ('Judaea Fox', '1.0.0', 'Judaea', '1'))
