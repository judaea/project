...
client_key = control.getSetting('fanart.apikey')

movies_poster_limit = int(control.getSetting('movies.poster_limit'))
movies_fanart_limit = int(control.getSetting('movies.fanart_limit'))
movies_keyart_limit = int(control.getSetting('movies.keyart_limit'))
movies_characterart_limit = int(control.getSetting('movies.characterart_limit'))
movies_banner = control.getSetting('movies.banner')
movies_clearlogo = control.getSetting('movies.clearlogo')
movies_landscape = control.getSetting('movies.landscape')
movies_clearart = control.getSetting('movies.clearart')
movies_discart = control.getSetting('movies.discart')

tvshows_poster_limit = int(control.getSetting('tvshows.poster_limit'))
tvshows_fanart_limit = int(control.getSetting('tvshows.fanart_limit'))
tvshows_keyart_limit = int(control.getSetting('tvshows.keyart_limit'))
tvshows_characterart_limit = int(control.getSetting('tvshows.characterart_limit'))
tvshows_banner = control.getSetting('tvshows.banner')
tvshows_clearlogo = control.getSetting('tvshows.clearlogo')
tvshows_landscape = control.getSetting('tvshows.landscape')
tvshows_clearart = control.getSetting('tvshows.clearart')
season_poster = control.getSetting('season.poster')
season_banner = control.getSetting('season.banner')
season_landscape = control.getSetting('season.landscape')
