...
from resources.lib.modules import premiumize, real_debrid, all_debrid
...
class BaseDebridWalker:
    ...
    def _format_items(self, items):
        for i in items:
            ...
            control.addDirectoryItem(i['name'], action, isPlayable=isPlayable, isFolder=isFolder,
                                   actionArgs=control.quote(actionArgs))
