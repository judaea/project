...
if action == 'adultNavigator':
    ...
    from resources.lib.indexers import iptv
    iptv.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import iptv
    iptv.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import iptv
    iptv.indexer().youtube(url, action)
...
elif action == 'arconaitvNavigator':
    from resources.lib.indexers import arconaitv
