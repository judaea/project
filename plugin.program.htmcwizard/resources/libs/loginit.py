...
LOGINID = {
	...
	'api-tmdb-david': {
		...
		'activate' : ''},
	'api-imdb-david': {
		'name'     : 'David - IMDb Personal API Key',
		'plugin'   : 'plugin.video.david',
		'saved'    : 'api-imdb-david',
		'path'     : os.path.join(ADDONS, 'plugin.video.david'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.david', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.david', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'api-imdb-david'),
		'settings' : os.path.join(ADDOND, 'plugin.video.david', 'settings.xml'),
		'default'  : 'imdb.user',
		'data'     : ['imdb.user'],
		'activate' : ''},
	'api-fanart-tv-david': {
		'name'     : 'David - Fanart.TV Personal API Key',
		'plugin'   : 'plugin.video.david',
		'saved'    : 'api-fanart-tv-david',
		'path'     : os.path.join(ADDONS, 'plugin.video.david'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.david', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.david', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'api-fanart-tv-david'),
		'settings' : os.path.join(ADDOND, 'plugin.video.david', 'settings.xml'),
		'default'  : 'fanart.tv.user',
		'data'     : ['fanart.tv.user'],
		'activate' : ''},
