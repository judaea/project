...
BUILDMENUFANART  = uservar.BUILDMENUFANART if not uservar.BUILDMENUFANART == 'http://' else FANART
...
def firstRun():
	...
	fr = MyWindow( "FirstRunBuild.xml" , ADDON.getAddonInfo('path'), 'DefaultSkin', title=ADDONTITLE, fanart=BUILDMENUFANART)
	fr.doModal()
	del fr
